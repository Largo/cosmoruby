#!/bin/bash
# Test script for mtsh command substitution (backticks and $())
...
echo "=== Testing mtsh command substitution ==="
echo
...
# In quotes: newlines are preserved (bash behavior)
# Unquoted: newlines become spaces for word splitting
test_feature_output "quoted preserves newlines" 'echo "$(echo a; echo b)"' "a
b"
test_feature_output "unquoted converts to spaces" 'echo $(echo a; echo b)' "a b"
...
TESTFILE="/tmp/mtsh_subst_test_$$.txt"
