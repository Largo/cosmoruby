...
module RbConfig
  ...
  CONFIG["COMMON_LIBS"] = ""
  CONFIG["MAINLIBS"] = "-ldl -lcrypt -lm -lpthread "
  ...
  CONFIG["AS"] = "as"
  CONFIG["AR"] = "ar"
  CONFIG["CC"] = "/home/groobiest/Code/jart/cosmopolitan/.cosmocc/current/bin/cosmocc"
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
...
require_relative 'rbconfig.mode'
  ...
  def RbConfig.ruby
    ...
    # instead of constructing /zip/bin/ruby.com which doesn't exist as a file.
