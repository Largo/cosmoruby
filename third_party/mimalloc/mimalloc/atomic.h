...
#endif
#include <windows.h>
#elif !defined(__wasi__) && (!defined(__EMSCRIPTEN__) || defined(__EMSCRIPTEN_PTHREADS__)) && !defined(__COSMOPOLITAN__)
#define  MI_USE_PTHREADS
#include <pthread.h>
#endif
// Cosmopolitan: Uses atomic spinlock fallback to avoid LIBC_THREAD circular dependency
