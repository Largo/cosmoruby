...
encsrcdir = .
topdir = .
prefix = /home/groobiest/.rbenv/versions/4.0.0
exec_prefix = /home/groobiest/.rbenv/versions/4.0.0
libdir = /home/groobiest/.rbenv/versions/4.0.0/lib
...
RUBY_SO_NAME = ruby
LIBRUBY = libruby.so.4.0.0
LIBRUBYARG_SHARED = -Wl,-rpath,/home/groobiest/.rbenv/versions/4.0.0/lib -L/home/groobiest/.rbenv/versions/4.0.0/lib -lruby
...
CCDLFLAGS = -fPIC
INCFLAGS = -I. -I$(arch_hdrdir) -I$(hdrdir) -I$(top_srcdir) -I/home/linuxbrew/.linuxbrew/Cellar/gmp/6.3.0/include
DEFS = 
CPPFLAGS =    -DONIG_ENC_REGISTER=rb_enc_register
LDFLAGS = -L. -fstack-protector-strong -L/home/linuxbrew/.linuxbrew/Cellar/gmp/6.3.0/lib -Wl,-rpath,/home/linuxbrew/.linuxbrew/Cellar/gmp/6.3.0/lib -rdynamic -Wl,-export-dynamic -Wl,--no-as-needed
LDSHARED = gcc -shared
POSTLINK = :
ldflags  = $(LDFLAGS)
dldflags = -Wl,--compress-debug-sections=zlib -L/home/linuxbrew/.linuxbrew/Cellar/gmp/6.3.0/lib -Wl,-rpath,/home/linuxbrew/.linuxbrew/Cellar/gmp/6.3.0/lib
extdldflags = 
archflag = 
...
LIBPATH = -L. -L$(topdir)
LIBS = $(LIBRUBYARG_SHARED) -lm -lpthread  $(EXTLIBS)
...
clean:
	...
	$(Q)$(RMALL) $(LIBENC)
	$(Q)$(RMALL) $(ENCOBJS)
	$(Q)$(RMALL) $(ENCCLEANOBJS)
	$(Q)$(RMALL) $(ENCCLEANLIBS)
	$(Q)$(RMALL) $(TRANSSOS)
	$(Q)$(RMALL) $(LIBTRANS)
	$(Q)$(RMALL) $(TRANSOBJS)
	$(Q)$(RMALL) $(TRANSCLEANOBJS)
	$(Q)$(RMALL) $(TRANSCLEANLIBS)
	$(Q)$(RMALL) $(ENC_TRANS_D)
	$(Q)$(RMALL) $(ENC_TRANS_SO_D)
	$(Q)$(RM) enc/unicode/*/casefold.h enc/unicode/*/name2ctype.h
	$(Q)$(RM) enc/trans/newline.c enc/jis/props.h
	-$(Q)$(RMDIR) enc/trnas enc/unicode 2> /dev/null || true
...
clean-srcs:
	$(Q)$(RM) $(TRANSCSRCS) $(BUILTIN_TRANS_CSRCS)
	-$(Q)$(RMDIR) enc/trans 2> /dev/null || true
	$(Q)$(RM) enc/unicode/*/casefold.h enc/unicode/*/name2ctype.h
