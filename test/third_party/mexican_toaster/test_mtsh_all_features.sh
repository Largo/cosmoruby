#!/bin/bash
# Comprehensive test suite for mtsh enhancements
...
echo "=== Testing mtsh: colon, comments, and grouping ==="
echo

echo "--- Colon command ---"
test_feature "colon no-op" ":" 0
test_feature "colon with redirect" ": > /tmp/mtsh_colon_test_$$.tmp && rm -f /tmp/mtsh_colon_test_$$.tmp" 0
