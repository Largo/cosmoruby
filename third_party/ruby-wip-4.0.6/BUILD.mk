...
ruby_verify:
	@HOST_RUBY="$(HOST_RUBY)" third_party/ruby-wip-4.0.6/cosmo_tests/check_export_tables.sh
	@HOST_RUBY="$(HOST_RUBY)" third_party/ruby-wip-4.0.6/cosmo_tests/check_export_tables_binary.sh
...
ruby_missing:
	...
	for ext in date digest etc io/nonblock json mbedtls monitor pathname psych socket sqlite3 stringio strscan zlib; do \
