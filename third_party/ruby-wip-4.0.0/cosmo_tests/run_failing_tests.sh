...
export RUBYLIB="$REPO_ROOT/third_party/ruby-wip-4.0.0/lib:$REPO_ROOT/third_party/ruby-wip-4.0.0/tool/lib"
...
# third_party/ruby-wip-4.0.0/test/ruby/test_process.rb

# Current known failures (timeout on memory leak stress tests - 3M iterations)
FAILING_TESTS="
$REPO_ROOT/third_party/ruby-wip-4.0.0/test/ruby/test_class.rb
$REPO_ROOT/third_party/ruby-wip-4.0.0/test/ruby/test_module.rb
"
