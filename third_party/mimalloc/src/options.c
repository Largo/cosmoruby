...
// Cosmopolitan: removed #include <stdio.h> - not needed (using _mi_prim_out_stderr instead)
...
void _mi_fputs(mi_output_fun* out, void* arg, const char* prefix, const char* message) {
  if (out==NULL) { // Cosmopolitan: removed stdout/stderr comparison (they're FILE*, not function pointers)
